...
$(document).ready(function(){
	...
	$(".article-tabs li").click(function(){	
		i=$(this).index();
		switch (i) {
		  case 0: $(this).siblings("a").attr("href","/news/notice");
			break;
		  case 1: $(this).siblings("a").attr("href","/news/consult");
			break;
		  case 2: $(this).siblings("a").attr("href","/news/help?getdata=1/0");
			break;
		  default: $(this).siblings("a").attr("href","/news/notice");
		}		
	});
	//article-tabs end
